...
function newTrack = checkSingleTrack(prevTrack, ...
    ...
    if any(prelimMask{1,1}(:)) && any(prelimMask{1,2}(:))
        ...
        d3d = norm(points3d - prevTrack.centroid3D);
...
%
    ...
    prev_3dpoints(1,:) = prevTracks(1).centroid3D;
    prev_3dpoints(2,:) = prevTracks(2).centroid3D;
...
%                         normalize_points(squeeze(new_centroids(iView,iBlob,:))', trackingBoxParams.K);
            ...
            newTracks(iTrack).centroid3D = curr_3dpoint;
