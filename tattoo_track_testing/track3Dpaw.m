...
while video.CurrentTime < video.Duration
    ...
    masked_mirror_img_enh = enhanceColorImage(masked_mirror_img, ...
                                              ...
                                              'mask',prev_paw_mask_center);
    [L,P] = imseggeodesic(masked_mirror_img_enh, mirror_zmask(:,:,2), mirror_zmask(:,:,3), mirror_zmask(:,:,4));
    [L2,P2] = imseggeodesic(masked_mirror_img_enh, mirror_zmask(:,:,3), mirror_zmask(:,:,4), mirror_zmask(:,:,5));
        
    % WORKING HERE... TRY PULLING OUT THE DIGITS FIRST, THEN MASK THE
    % DORSUM OF THE PAW. THEN, CREATE A MASK FOR THE WHOLE PAW TO USE IN
