function [endMasks, tangentPoints] = matchSilhouettes(initMasks, fundmat, bboxes, imSize)
%
% INPUTS:
%   initMasks
% OUTPUTS:
...
%         linePts = reshape(squeeze(epiPts(matchLineIdx(ii),:,3-interiorMask(ii))),[2,2])';
        linePts = reshape(squeeze(epiPts(ii,:,3-interiorMask(ii))),[2,2])';
