function triggerTime = identifyTriggerTime_greenPaw_20160413( video, rat_metadata, session_mp, cameraParams, boxRegions, varargin )
%
% INPUTS:
...
reach_bbox(1) = reach_bbox(1) - ROI(1) + 1;
...
%     fprintf('frame number: %d\n', frameNum)
    ...
    mask = HSVthreshold(decorr_hsv, pawHSVrange(1,:));
