...
% Pinky distal
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [pelletCenter, centerBackPaw, thumbProx, thumbDist, indexProx, indexMid, indexDist,middleProx, middleMid, middleDist, ringProx, ringMid, ringDist, pinkyPox ,pinkyMid, pinkyDist] = readDataFromPawPoints(pawPointsData)

function [pawCoords] = analyzeManualTrialData(pawPointsData)
overallCounter = 1;
