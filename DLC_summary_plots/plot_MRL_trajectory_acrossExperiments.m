function plot_MRL_trajectory_acrossExperiments(exptSummary)
%
% exptSummary - types
%   1 - chr2 during
%   2 - chr2 between
...
saveName = 'MRL_trajectories_across_expt.pdf';
...
for i_exptType = 1 : length(exptTypeIdx)
    ...
    MRL_traj = squeeze(nanmean(curSummary.MRL_traj,1));
