...
%      applied to the GUI before GUIcreateFrameStartVP2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUIcreateFrameStartVP2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUIcreateFrameStartVP2

% Last Modified by GUIDE v2.5 11-May-2015 18:46:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUIcreateFrameStartVP2_OpeningFcn, ...
                   'gui_OutputFcn',  @GUIcreateFrameStartVP2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUIcreateFrameStartVP2 is made visible.
function GUIcreateFrameStartVP2_OpeningFcn(hObject, eventdata, handles, varargin)
