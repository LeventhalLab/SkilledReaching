...
while current_month.Month <= last_month.Month
    ...
    dist = [cameraParams.RadialDistortion(1:2), cameraParams.TangentialDistortion];
...
%         end
    ...
    %             scatter3(wpts(:,1),wpts(:,2),wpts(:,3))
        ...
        save(calibrationFileName,'P','Pn','F','E','K','dist','scaleFactor','directChecks','mirrorChecks','cameraParams','curDate','imFileList');
