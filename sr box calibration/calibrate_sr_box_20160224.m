function boxCalibration = calibrate_sr_box_20160224(BGimg, varargin)
%
...
% find the front panel of the box - white vertical bars in the direct view
% and black vertical bars in the mirror views
