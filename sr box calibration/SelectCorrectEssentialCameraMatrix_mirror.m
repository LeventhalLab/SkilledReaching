function [cRot,cT,correct] = SelectCorrectEssentialCameraMatrix_mirror(rot,t,x1,x2,k)
...
% above 2 lines added by DL 20150817 to convert to homogeneous coordinates
