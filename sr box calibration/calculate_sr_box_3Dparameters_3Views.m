...
function [scale, F, P1, P2, P3, wpts, reproj] = calculate_sr_box_3Dparameters_3Views(K,mp,boardSize,varargin)
% 3Views: added info for top mirror
%
% usage: 
%
% INPUTS:
...
%       board is used in the left, right, and top views
%
% OUTPUTS:
...
%       scale(2) is for the right mirror, and scale(3) is for the top
%       mirror
...
%       right mirrors, respectively (and F.top for top mirror)
...
% assumption - the intrinsic parameters are the
...
[cRot,cT,~] = SelectCorrectEssentialCameraMatrix_mirror(rot,t,squeeze(mp(:,:,1))',squeeze(mp(:,:,2))',K');
P1 = [cRot,cT];
P1 = P1';
