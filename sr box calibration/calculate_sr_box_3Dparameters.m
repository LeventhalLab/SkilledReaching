function [scale,F,P1,P2] = calculate_sr_box_3Dparameters(K,mp,boardSize,varargin)
%
% usage: 
%
% INPUTS:
...
% mirrors
F.left = fundMatrix_mirror(mp(:,:,2), mp(:,:,1));
...
wpts_left  = triangulate_DL(l_direct_norm, l_mirror_norm, P, P1);
wpts_right = triangulate_DL(r_direct_norm, r_mirror_norm, P, P2);

% calculate mean spacing between checkerboard points
[d_horiz_left,d_vert_left] = calc_cb_spacing(wpts_left,boardSize);
[d_horiz_right,d_vert_right] = calc_cb_spacing(wpts_right,boardSize);
