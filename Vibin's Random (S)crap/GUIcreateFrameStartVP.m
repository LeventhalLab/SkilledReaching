function varargout = GUIcreateFrameStartVP(varargin)
...
% Last Modified by GUIDE v2.5 08-May-2015 15:48:58
...
function video_frame_DeleteFcn(hObject, eventdata, handles)
% hObject    handle to video_frame (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
