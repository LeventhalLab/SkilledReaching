...
%
% script to interpolate trajectories and fill in missing points (either
% hidden, poorly identified by DLC, could not be sorted out using 3D
% geometry)
...
% change the name of the file below depending on the specific database
% being used
