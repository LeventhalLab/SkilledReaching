...
exptOutcomeSummary.mean_dig2_endPt_z = exptOutcomeSummary.mean_dig2_endPt_z*-1;
...
for i = [2 5]      % plot successful and failed reaches 
...
box off
set(gca,'xlim',[0 23],'ylim',[minValue maxValue],'ytick',[-10 0 15]);
