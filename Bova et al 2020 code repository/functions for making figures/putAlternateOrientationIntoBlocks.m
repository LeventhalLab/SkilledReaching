function dataMatrix = putAlternateOrientationIntoBlocks(alternateKinematicSummaryHisto)
    ...
    for i_trial = 2:size(alternateKinematicSummaryHisto(i_sess).laserInfo,1)
        ...
        elseif cur_trial == 0 || cur_trial == 1
            ...
            if isempty(cur_row)
                ...
                kinemData = alternateKinematicSummaryHisto(i_sess).orientation(cur_row); 
