...
%         end
        ...
        if ~exist(interpTrajectoryName,'file')
            continue;
        end
...
%             sessionSummary = sessionKinematicsSummary(reachData);
        ...
        save(reachDataName,'reachData','sessionSummary','all_didPawStartThroughSlot','all_frameRange','all_initPellet3D','all_slot_z_wrt_pellet','frameRate','pelletMissingFlag','slot_z','trialNumbers','curSessionDir','thisRatInfo');
