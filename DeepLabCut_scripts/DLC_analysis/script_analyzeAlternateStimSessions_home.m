...
rootFolder = '/Volumes/Untitled/for_creating_3d_vids';

alternatingStimFolder = fullfile(rootFolder, 'alternating stim analysis');
DLCoutput_folder = rootFolder; %'/Volumes/LL EXHD #2/DLC output';
if ~exist(alternatingStimFolder,'dir')
    mkdir(alternatingStimFolder);
end

xlDir = rootFolder;%'/Users/dan/Box Sync/Leventhal Lab/Skilled Reaching Project/Scoring Sheets';
