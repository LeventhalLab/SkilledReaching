...
%     sharedX_ratRootFolder = fullfile(sharedX_DLCoutput_path,ratID);
    ...
    % use below to select specific sessions for specific rats for analysis
%     switch ratID
%         case 'R0158'
%             startSession = 19;
%             endSession = 19;
...
%     end
    for iSession = startSession : 1 : endSession
        ...
        % directory containing the data for an individual session
        fullSessionDir = fullfile(ratRootFolder,sessionDirectories{iSession});
        
        % comment in lines below to allow backup to a network drive
...
%         end
        ...
        % parse out session information from the folder name
