...
% to plot:
% ROW 1
%   1. number of trials per session as a function of test day
%   2. accuracy (1st reach) as a function of test day
%   3. accuracy (any reach) as a function of test day
%   
...
legend('first paw','through slot','end point','max reach','location','southwest');
