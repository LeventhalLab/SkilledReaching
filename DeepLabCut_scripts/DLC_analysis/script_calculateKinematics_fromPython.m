...
%         allSessionIdx = find(sessionDate == allSessionDates);
        ...
        for iTrial = 1 : numTrials
            C = textscan(pawTrajectoryList(iTrial).name, [ratID '_box%d_' sessionDateString '_%d-%d-%d_%d_3dtrajectory.mat']); 
            trialNumbers(iTrial,1) = C{5};
        end
...
%         end
        ...
        for iTrial = 1 : numTrials
            ...
            trialOutcome = 0;%sessionReachScores(trialNumbers(iTrial,2));
