function [pawTrajectory, bodyparts, final_direct_pts, final_mirror_pts, isEstimate] = calc3D_DLC_trajectory(final_direct_pts, final_mirror_pts, invalid_direct, invalid_mirror, direct_bp, mirror_bp, ROIs, boxCal, pawPref, imSize, varargin)
%
% INPUTS:
...
[final_direct_pts,final_mirror_pts,isEstimate] = ...
    estimateHiddenPoints(final_direct_pts, final_mirror_pts, invalid_direct, invalid_mirror, direct_bp, mirror_bp, boxCal, ROIs, imSize, pawPref,'maxDistFromNeighbor',maxDistFromNeighbor);
