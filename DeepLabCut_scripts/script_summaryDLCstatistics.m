        ...
        for iTrial = 1 : numTrials
            ...
            for i_bpGroup = 1 : length(bp_to_group)
                ...
                for ii = 1 : length(bp_idx)
                    ...
                    toPlot = squeeze(curTrajectories(1:lastPt,:,bp_idx(ii)));
                ...
                for ii = 1 : length(bp_idx)
                    ...
                    toPlot = squeeze(direct_pts(bp_idx(ii),:,1));
                    ...
                    toPlot = squeeze(mirror_pts(bp_idx(ii),:,1));
                    ...
                    toPlot = squeeze(direct_pts(bp_idx(ii),:,2));
                    toPlot(direct_invalid_points(bp_idx(ii),:)) = NaN;
                    toPlot = toPlot(1:lastPt);
                    plot(toPlot)
                    hold on
                    ...
                    toPlot = squeeze(mirror_pts(bp_idx(ii),:,2));
                    toPlot(mirror_invalid_points(bp_idx(ii),:)) = NaN;
                    toPlot = toPlot(1:lastPt);
                    plot(toPlot)
                    hold on
