...
leftMirrorPoints  = zeros(12,2);    % markers in the left mirror
rightMirrorPoints = zeros(12,2);    % markers in the right mirror
left_center_points  = zeros(12,2); % markers to match with the left mirror in the center image
right_center_points = zeros(12,2); % markers to match with the right mirror in the center image
