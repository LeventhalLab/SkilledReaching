...
%     endDateNum = datenum(sr_ratInfo(i_rat).date.end, 'yyyymmdd');
    ...
    for iSession = 5:6%7:length(sessionList)
...
%                     'stretch_hist_limit_ext',stretch_hist_limit_ext);
                ...
                [points2d,timeList,isPawVisible_mirror] = trackMirrorView_relRGB_20170331(video, triggerTime, initPawMask, BGimg_ud, sr_ratInfo(i_rat), boxRegions,boxCalibration,greenBGmask);
