function [fullMask,greenMask] = trackNextStep_mirror_20160427( image_ud, fundMat, prevMask, boxRegions, pawPref, varargin)
...
mirror_image_ud = imadjust(mirror_image_ud,lo_hi,[]);
...
y = decorrstretch(mirror_image_ud,'targetmean',targetMean(1,:),'targetsigma',targetSigma(1,:));
...
whiteMask_ext = mirror_image_ud(:,:,1) > whiteThresh_ext & ...
                mirror_image_ud(:,:,2) > whiteThresh_ext & ...
                mirror_image_ud(:,:,3) > whiteThresh_ext;
whiteMask_ext = whiteMask_ext & extMask;

whiteMask_int = mirror_image_ud(:,:,1) > whiteThresh_int & ...
                mirror_image_ud(:,:,2) > whiteThresh_int & ...
                mirror_image_ud(:,:,3) > whiteThresh_int;
