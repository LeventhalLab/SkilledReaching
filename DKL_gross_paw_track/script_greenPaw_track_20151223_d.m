...
%                     'foregroundthresh',foregroundThresh);
                ...
                [mirror_points2d,timeList,isPawVisible_mirror] = trackMirrorView_d(video, triggerTime, initPawMask, BGimg_ud, sr_ratInfo(i_rat), boxRegions,boxCalibration,greenBGmask,...
                    'hsvlimits', pawHSVrange,...
                    'foregroundthresh',foregroundThresh,...
                    'targetmean',targetMean,...
                    'targetsigma',targetSigma,...
