function [points3d,points2d,timeList,isPawVisible] = trackDirectView_c( video, triggerTime, initPawMask, mirror_points2d, BGimg_ud, sr_ratInfo, boxRegions, boxCalibration,greenBGmask,varargin )
...
[rpoints2d, rpoints3d, timeList_b,isPawVisible_b] = trackPaw_direct_local( video, BGimg_ud, greenBGmask, initPawMask{1},mirror_points2d, boxRegions, pawPref, 'reverse',boxCalibration,...
                                     'foregroundthresh',foregroundThresh,...
                                     'pawhsvrange',pawHSVrange,...
                                     'maxdistperframe',maxDistPerFrame,...
                                     'targetmean',targetMean,...
...
%     image_ud = color_adapthisteq(image_ud);
    ...
    [fullMask] = trackNextStep_direct_20160512_c(image_ud,prevMask,cur_points2d,boxRegions,pawPref,boxCalibration,greenBGmask,...
                             'foregroundthresh',foregroundThresh,...
                             'pawhsvrange',pawHSVrange,...
                             'maxdistperframe',maxDistPerFrame,...
                             'targetmean',targetMean,...
