function [points2d,timeList,isPawVisible] = trackMirrorView_relRGB_20170331( video, triggerTime, initPawMask, BGimg_ud, sr_ratInfo, boxRegions, boxCalibration, greenBGmask, varargin )
...
%     prev_im_ud = image_ud;
    ...
    [fullMask] = trackNextStep_mirror_relRGB_20170331(image_ud,BGimg_ud,fundMat,greenBGmask,prevMask,boxRegions,pawPref);
