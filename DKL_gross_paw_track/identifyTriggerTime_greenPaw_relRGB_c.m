function triggerTime = identifyTriggerTime_greenPaw_relRGB_c( video, rat_metadata, session_mp, cameraParams, varargin )
...
pixCountThresh = 2500;
minPixCount = 400;    % mininum number of green pixels to count as the paw being visible
