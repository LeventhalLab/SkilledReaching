...
for ii = 1 : size(ratIDlist,1)
    ...
    switch lower(ratID)
        case 'r0027',
            ...
            pawPref = 'right';
            sessionList = {'20140508a','20140509a','20140512a','20140513a','20140514a','20140515a','20140516a','20140519a','20140520a','20140521a','20140522a','20140523a','20140527a','20140528a','20140529a'};
        case 'r0028',
        ...
        case 'r0030',
            ...
            dateLimits.end = '20140509';
            pawPref = 'right';
            sessionList = {'20140423a','20140424a','20140425a','20140426a','20140427a','20140428a','20140429a','20140430a','20140501d','20140502a','20140505a','20140506a','20140507a','20140508a'};
