...
%                                                    'targetsigma',targetSigma);
                triggerTime = identifyTriggerTime_greenPaw_relRGB_c( video, sr_ratInfo(i_rat), session_mp, cameraParams);
...
%                     'stretch_hist_limit_ext',stretch_hist_limit_ext);
                ...
                [points2d,timeList,isPawVisible_mirror] = trackMirrorView_relRGB_20170331_c(video, triggerTime, initPawMask, BGimg_ud, sr_ratInfo(i_rat), boxRegions,boxCalibration,greenBGmask);
