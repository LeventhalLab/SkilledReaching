...
%
% take the interpolated trajectories generated by
% script_interp_trajectories and identify individual reaches within each
% trial, their start points,end points, etc., and calculate statistics for
% reaches across the full session. Write results into a file containing
% data for each trial as well as a summary of session statistics
