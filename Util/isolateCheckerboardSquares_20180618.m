function [whiteMask, blackMask, errorFlag] = isolateCheckerboardSquares_20180618(testGray, boardMask, anticipatedBoardSize, varargin)
% threshStep = 0.02;
% curWhiteThresh = 0.5;
% curBlackThresh = 0.5;
% maxIterations = 20;
...
interChecks = q < gradientThresh & boardMask;
q_adj = imadjust(q);
