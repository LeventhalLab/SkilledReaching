...
selectPawPref = 'right';
selectTattoo = 'yes';
digitColors = 'gpbyr';   % order of colors on the digits (digits 1-4 and dorsum of paw).
...
if ~selectRandomVideos
    ...
    sessionsToExtract(ii).session = '20170813a';
    
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180519a'; 
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180521a'; 
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180522a'; 
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180523a';
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180524a'; 
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180525a'; 
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180526a'; 
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180528a';
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180529a'; 
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180530a'; 
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180531a'; 
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180601a';
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180603a';
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180604a';
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180605a'; 
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180606a'; 
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180607a'; 
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180608a';
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180609a';
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180611a';
%     
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
%     sessionsToExtract(ii).session = '20180612a';
% 
%     ii = ii+1;
%     sessionsToExtract(ii).ratID = ratID;
